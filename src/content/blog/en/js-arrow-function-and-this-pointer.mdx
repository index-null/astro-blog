...
> For what exactly happens with `new`, see my other article → [new Call — How a Function Becomes an Object](/posts/new-call-to-create-object)

> For a quick primer on `call` / `apply` / `bind` → [Remember call, apply, bind in Three Sentences](/posts/this-pointer-bind-three-methods)
