...
> Arrow functions have no own `this`, so these three methods have no effect on them. See [Arrow Functions and `this`](/posts/js-arrow-function-and-this-pointer) for details.
