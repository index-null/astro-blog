...
`new` is the most puzzling among the [four ways `this` can be invoked](/posts/js-arrow-function-and-this-pointer). You write `new Dog()` and get an empty object — what actually happens in between?
...
Dive deeper here: [Prototype Chain — From `new` an Object to the Essence of Method Sharing](/posts/js-prototype-chain)
